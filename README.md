...
- Phase 8B 整书摘要 retrieval 增强补丁
- Phase 9 整书级检查 / 长线连续性最小链
- Phase 10A 工作台 / 导出 / 重建 / 成品化最小链
- Phase 10B 项目导出 / 导入 / 归档 / 备份最小链
- Phase 11 发布加固 / 上线前清理最小链
...
- `/studio` 工作台与 scene / chapter / volume / book 页面最小工作流
...
- `/studio` 工作台继续是同步工作台，不提供后台任务队列或自动运维
...
- 发布加固只收口成品化 / 工作台直连边界，不做全项目错误协议重构
